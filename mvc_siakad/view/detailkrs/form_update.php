          ...
          <form method="post" action="index.php?lihat=utama/index_detailkrs&update=true">
            <div class="form-group">
              ...
              <?php foreach ($data as $value) {?>
                ...
                <label>ID KRS</label>
                <input type ="text" id="idKrs" value = "<?php echo $value['idKrs']?>" name = "idKrs" class="form-control" readonly>
              ...
              <?php if ($_SESSION['level'] == "admin") { ?>
                ...
                <div class="form-group">
                  ...
                  <input type ="text" id="praktikum" value = "<?php echo $value['praktikum']?>" name = "praktikum" class="form-control" >
                </div>
                <div class="form-group">
                  <label>Tugas</label>
