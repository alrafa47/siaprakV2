          ...
          <form method="post" action="index.php?lihat=utama/index_krs&update=true">
            <div class="form-group">
              ...
              <?php foreach ($data as $value) {?>
                <input type="hidden" name="idKrs" value="<?php echo $value['idKrs'] ?>" class="form-control" readonly="readonly"> 
              </div>
              <div class="form-group">
                <label>NPM</label>                
                <input type="text" name="npm" value="<?php echo $value['npm'] ?>" class="form-control" required readonly>
              </div>
              <div class="form-group">
