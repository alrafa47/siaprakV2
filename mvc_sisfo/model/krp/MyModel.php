<?php 
	class MyModel{
		...
		public function get_connection(){
	        ...
	        $this->conn = false;
	        try {
	            $this->conn = new PDO('mysql:host=localhost;dbname=siaprak', 'root', '');
		...
		public function insert_mhs($idKrp,$npm,$tahunAjaran,$tanggal){

			$koneksi = $this->get_connection();
			$statement = $koneksi->prepare("INSERT INTO krp(idKrp,npm,tahunAjaran,tanggal) VALUES(?,?,?,?)");
			return $statement->execute(array($idMk,$namaMk,$tahunAjaran,$tanggal));
